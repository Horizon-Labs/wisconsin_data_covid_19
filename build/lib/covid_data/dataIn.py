...
def gen_sample_data(n=10000, distribution="Tot_Population_ACS_14_18", file="vaccinations.csv"):
    global wisconsin_census
    ...
    for i in range(len(wisconsin_census['GIDSTCO'])):
        split[runningTotal] = wisconsin_census['GIDSTCO'][i]
